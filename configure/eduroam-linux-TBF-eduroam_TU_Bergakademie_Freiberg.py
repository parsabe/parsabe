...
Messages.cat_dir_exists = "Directory {} exists; some of its files may " \
    "be overwritten"
Config.instname = "TU Bergakademie Freiberg"
Config.profilename = "eduroam TU Bergakademie Freiberg"
Config.url = "https://tu-freiberg.de/urz/dienste/servicedesk"
Config.email = "servicedesk@tu-freiberg.de"
Config.title = "eduroam CAT"
Config.server_match = "hrz.tu-freiberg.de"
...
Config.user_realm = "tu-freiberg.de"
Config.ssids = ['eduroam']
Config.del_ssids = []
Config.servers = ['DNS:radius1.hrz.tu-freiberg.de', 'DNS:radius2.hrz.tu-freiberg.de']
Config.use_other_tls_id = False
Config.anonymous_identity = "roaming@tu-freiberg.de"
